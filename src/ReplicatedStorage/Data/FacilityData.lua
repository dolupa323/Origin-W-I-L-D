...
local FacilityData = {
	...
	},
	{
		...
		requirements = { { itemId = "BOUND_LOG", amount = 2 } },
		maxHealth = 150,
		techLevel = 1,
	...
	},
	{
		...
		requirements = { { itemId = "LOG", amount = 5 }, { itemId = "STONE", amount = 5 } },
		maxHealth = 200,
		techLevel = 1,
		functionType = "REPAIR",
	},
	{
		id = "TECH_LAB",
		name = "기술 연구소",
		description = "고대 유물과 미지의 재료를 분석하여 새로운 기술을 해금합니다.",
		modelName = "TechLab",
		requirements = { { itemId = "LOG", amount = 10 }, { itemId = "STONE", amount = 10 }, { itemId = "BONE", amount = 2 } },
		maxHealth = 400,
		techLevel = 1,
		functionType = "TECH_UNLOCK",
	},
	...
	},
	{
		...
		name = "조잡한 작업대",
		description = "Tier 1 도구와 장비를 제작할 수 있습니다.",
		modelName = "PrimitiveWorkbench",
		requirements = { { itemId = "LOG", amount = 5 }, { itemId = "VINE", amount = 3 } },
		maxHealth = 200,
		techLevel = 1,
